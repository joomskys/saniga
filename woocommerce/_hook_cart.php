...
if(!function_exists('saniga_woocommerce_cart_actions')){
	...
	?>
		<div class="pt-30 row justify-content-between gutters-30 gutters-grid">
			<?php if ( wc_coupons_enabled() ) { ?>
				<div class="coupon col-12 col-xl-basic">
					<div class="row gutters-30 gutters-grid">
						...
						<div class="col-12 col-sm-auto">
							<button type="submit" class="button btn-xlg w-100 btn-accent" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'saniga' ); ?>"><?php esc_html_e( 'Apply coupon', 'saniga' ); ?></button>
						</div>
			...
			<div class="col-12 col-xl-auto">
				<div class="row gutters-30 gutters-grid justify-content-end">
					<div class="col-12 col-sm-auto">
