 ...
 * @return string
 */
function saniga_get_theme_opt_name()
{
    return apply_filters('saniga_theme_opt_name', 'cms_theme_options');
}
 ...
 * @return mixed
 */
function saniga_get_theme_opt($opt_id, $default = false, $exclude = ''){
    $opt_name      = saniga_get_theme_opt_name();
    if (empty($opt_name)) {
        return $default;
    }
    global ${$opt_name};
 ...
 * @return string
 */
function saniga_get_page_opt_name() {
	return apply_filters( 'saniga_page_opt_name', 'cms_page_options' );
}
/**
 * Get theme option based on its id.
 *
 ...
 * @return mixed
 */
function saniga_get_page_opt($opt_id, $default = false)
{
    $page_opt_name = saniga_get_page_opt_name();
 ...
 * @return mixed
 */
function saniga_get_page_opt_old( $opt_id, $default = false ) {
	$page_opt_name = saniga_get_page_opt_name();
	if ( empty( $page_opt_name ) ) {
		return $default;
	}
 ...
 * @return mixed
 */
function saniga_get_opts($opt_id, $default = false){
    $theme_opt = saniga_get_theme_opt($opt_id, $default);
    $page_opt  = saniga_get_page_opt($opt_id, $theme_opt);
 ...
 * @return bool|mixed
 */
function saniga_get_post_format_value($id=null,$post_format_key, $default = '')
{
    global $post;
