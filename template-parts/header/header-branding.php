...
$logo = saniga_get_opts( 'logo', array( 'url' => saniga_configs('logo')['default'], 'id' => '' ) );
$logo_url = $logo['url'];

$logo_ontop = saniga_get_opts( 'logo_ontop', array( 'url' => saniga_configs('logo')['ontop'], 'id' => '' ) );
$logo_ontop_url = $logo_ontop['url'];

$logo_sticky = saniga_get_opts( 'logo_sticky', array( 'url' => saniga_configs('logo')['sticky'], 'id' => '' ) );
$logo_sticky_url = $logo_sticky['url'];

$logo_mobile = saniga_get_opts( 'logo_mobile', array( 'url' => saniga_configs('logo')['mobile'], 'id' => '' ) );
