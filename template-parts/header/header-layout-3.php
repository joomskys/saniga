    ...
    <div class="<?php saniga_header_container_css_class(); ?>">
        <div class="row gutters-xl-40 justify-content-between align-items-center">
            ...
            <div class="cms-navigation col">
                <div class="row gutters-20 gutters-xl-40 align-items-center justify-content-end">
                    ...
                    <div class="<?php saniga_site_menu_right_class('col-12 col-xl-auto');?>">
                        <div class="cms-navigation-attrs-inner row gutters-20 gutters-xl-40 align-items-center">
                            <?php 
                                saniga_header_search([
                                    'class' => 'col-auto cms-hidden-lg',
                                    'before' => '<div class="header-separator col-auto cms-hidden-lg header-height"><span></span></div>'
                                ]); 
                                saniga_header_cart([
                                    'class' => 'col-auto cms-hidden-lg',
                                    'before' => '<div class="header-separator col-auto cms-hidden-lg header-height"><span></span></div>'
                                ...
                                saniga_header_social([
                                    'before' => '<div class="header-separator col-auto cms-hidden-lg header-height"><span></span></div><div class="cms-socials-wrap col-auto cms-hidden-lg"><div class="row gutters-5 gutters-grid justify-content-center">', 
                                    'after'  => '</div></div>',
                                ...
                                saniga_header_button([
                                    'class'     => 'col-12 col-md-6 col-xl-auto header-height pr-0',
                                    'btn_class' => 'btn btn-md btn-secondary cms-btn-header h-100 d-flex align-items-center p-lr-xl-50',
                                    'before' => '<div class="header-separator col-auto cms-hidden-lg"><span></span></div>'
                                ]);
                                saniga_header_button2([
                                    'class'      => 'col-12 col-md-6 col-xl-auto header-height pr-0',
                                    'btn_class'  => 'btn btn-md btn-accent btn-hover-secondary cms-btn-header h-100 d-flex align-items-center p-lr-xl-50',
                                    'before' => '<div class="header-separator col-auto cms-hidden-lg header-height"><span></span></div>'
                                ]);
                            ?>
                        </div>
