                        ...
                        array(
							...
							'options' => [
                                ...
                                /*'3' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_quickcontact/layout-image/3.png'
                                ],
                                '4' => [
                                    'label' => esc_html__( 'Layout 4', 'saniga' ),
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_quickcontact/layout-image/4.png'
                                ],
                                '5' => [
                                ...
                                '7' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_quickcontact/layout-image/7.png'
                                ],
                                '8' => [
                                    'label' => esc_html__( 'Layout 8', 'saniga' ),
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_quickcontact/layout-image/8.png'
                                ],
                                '9' => [
                                    'label' => esc_html__( 'Layout 9', 'saniga' ),
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_quickcontact/layout-image/9.png'
                                ],
                                '10' => [
                                    'label' => esc_html__( 'Layout 10', 'saniga' ),
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_quickcontact/layout-image/10.png'
                                ],*/
                            ],
