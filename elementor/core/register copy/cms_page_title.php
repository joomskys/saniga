                        ...
                        array(
                            ...
                            'options' => [
                                ...
                                '3' => [
                                    ...
                                    'image'      => get_template_directory_uri() . '/elementor/templates/widgets/cms_page_title/layout-images/3.png'
                                ],
                                '4' => [
                                    'label'      => esc_html__( 'Layout 4', 'saniga' ),
                                    'image'      => get_template_directory_uri() . '/elementor/templates/widgets/cms_page_title/layout-images/4.png'
                                ],
                                '5' => [
                                    'label'      => esc_html__( 'Layout 5', 'saniga' ),
                                    'image'      => get_template_directory_uri() . '/elementor/templates/widgets/cms_page_title/layout-images/5.png'
                                ],
                            ],
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'options'     => [
                                ...
                                '6'      => esc_html__('Gradient 6', 'saniga'),
                                '7'      => esc_html__('Gradient 7', 'saniga'),
                                '8'      => esc_html__('Gradient 8', 'saniga'),
