<?php
// Register Post Featured
etc_add_custom_widget(
    array(
        'name'       => 'cms_post_featured',
        'title'      => esc_html__( 'CMS Post Featured', 'saniga' ),
        ...
        'params'     => array(
            'sections' => array(
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image'      => get_template_directory_uri() . '/elementor/templates/widgets/cms_post_featured/layout-images/1.png'
                                ],
                            ],
                            'prefix_class' => 'cms-post-featured-layout-'
                        )
                    ),
                ),
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'description' => esc_html__( 'Choose Background. Default is post featured image', 'saniga' ),
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .cms-post-featured-gradient' => 'background-color: {{VALUE}};'
                            ]
                        ),
                        array(
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .cms-post-featured-gradient' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{bg_overlay_color.VALUE}} {{bg_overlay_color_stop.SIZE}}{{bg_overlay_color_stop.UNIT}}, {{bg_overlay_color_b.VALUE}} {{bg_overlay_color_b_stop.SIZE}}{{bg_overlay_color_b_stop.UNIT}})',
                            ],
                            'condition' => [
                                'bg_overlay'      => [ 'custom' ],
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .cms-post-featured-gradient' => 'background-color: transparent; background-image: radial-gradient(at {{VALUE}}, {{bg_overlay_color.VALUE}} {{bg_overlay_color_stop.SIZE}}{{bg_overlay_color_stop.UNIT}}, {{bg_overlay_color_b.VALUE}} {{bg_overlay_color_b_stop.SIZE}}{{bg_overlay_color_b_stop.UNIT}})',
                            ],
                            'condition' => [
                                'bg_overlay'      => [ 'custom' ],
                    ...
                    'controls' => array_merge(
                        array(
                            ...
                            array(
                                ...
                                'default'     => '',
                                'placeholder' => esc_html__( 'Enter your title. Default is title of post', 'saniga' ),
                                'label_block' => true,
                            ),
                            array(
                                'name'        => 'heading_color',
                ...
                array(
                    'name'     => 'button_section',
                    'label'    => esc_html__( 'Buttons', 'saniga' ),
                    'tab'      => \Elementor\Controls_Manager::TAB_CONTENT,
                    'controls' => array_merge(
                        saniga_elementor_button_settings([
                            'btn_text'         => 'Schedule A Visit',
                            'btn_type_default' => 'just-link',
                        ]),
                        array(
                            array(
                ...
                array(
                    'name'     => 'rating_section',
                    'label'    => esc_html__( 'Rating Settings', 'saniga' ),
                    'tab'      => \Elementor\Controls_Manager::TAB_CONTENT,
                    'controls' => array_merge(
                        array(
                            array(
                                'name'    => 'show_rating',
                                'label'   => esc_html__( 'Show Rating', 'saniga' ),
                                'type'    => \Elementor\Controls_Manager::SWITCHER,
                                'default' => 'true'
                            ),
                            array(
                                'name'        => 'rated_color',
                                'label'       => esc_html__( 'Rated Color', 'saniga' ),
                                'type'        => \Elementor\Controls_Manager::SELECT,
                                'options'     => saniga_elementor_theme_color_opts(),  
                                'default'     => '',
                                'condition' => [
                            ...
                            array(
                                'name'    => 'rating_total',
                                'label'   => esc_html__( 'Total Rating', 'saniga' ),
                                'type'    => \Elementor\Controls_Manager::NUMBER,
                                'condition' => [
                                    'show_rating' => 'true'
                                ]
                            ...
                            array(
                                'name'        => 'text1_color',
                                'label'       => esc_html__( 'Text1 Color', 'saniga' ),
                                'type'        => \Elementor\Controls_Manager::SELECT,
                                'options'     => saniga_elementor_theme_color_opts(),  
                                'default'     => '',
                                'condition' => [
                            ...
                            array(
                                'name'    => 'rating_text3',
                                'label'   => esc_html__( 'Text 3', 'saniga' ),
                                'type'    => \Elementor\Controls_Manager::TEXTAREA,
                                'condition' => [
                                    'show_rating' => 'true'
                                ]
                            ...
                            array(
                                'name'    => 'rating_text4',
                                'label'   => esc_html__( 'Text 4', 'saniga' ),
                                'type'    => \Elementor\Controls_Manager::TEXTAREA,
                                'condition' => [
                                    'show_rating' => 'true'
                                ]
