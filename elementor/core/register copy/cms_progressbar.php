...
etc_add_custom_widget(
    array(
        ...
        'title' => esc_html__( 'CMS Progress Bar', 'saniga' ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'label' => esc_html__( 'Progress Bar Lists', 'saniga' ),
                            ...
                            'controls' => array(
                                array(
                                    ...
                                    'default' => esc_html__( 'My Skill', 'saniga' ),
                                    'label_block' => true,
                                ),
                                array(
                                    'name' => 'percent',
                                    'label' => esc_html__( 'Percentage', 'saniga' ),
