<?php 
// Wrap 
$widget->add_render_attribute( 'wrap', 'class', 'cms-ptitle-wrapper cms-bg-cover');
...
// Overlay 
$widget->add_render_attribute( 'overlay', 'class', 'cms-page-title-gradient');
$widget->add_render_attribute( 'overlay', 'class', 'cms-gradient-'.$widget->get_setting('bg_overlay', '3'));
// Heading
$heading_text = $widget->get_setting('heading_text', get_the_title());
$widget->add_render_attribute( 'heading', 'class', 'cms-heading text-40 pb-20');
...
// Sub Heading
$subheading_text = $widget->get_setting('heading_text', wp_trim_words(get_the_excerpt(), '18', ''));
$widget->add_render_attribute( 'subheading', 'class', 'cms-subheading text-17 lh-27 pr-xl-100 font-700 pb-30');
...
<div <?php etc_print_html($widget->get_render_attribute_string( 'wrap' )); ?>>
    <div <?php etc_print_html($widget->get_render_attribute_string( 'overlay' )); ?>>
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-10">
                    <div <?php etc_print_html($widget->get_render_attribute_string( 'heading' )); ?>><?php
                        ...
                        etc_print_html($heading_text);
                    ?></div>
                    <div <?php etc_print_html($widget->get_render_attribute_string( 'subheading' )); ?>><?php
                        etc_print_html($subheading_text);
                    ?></div>
                    <div class="row empty-none"><?php
