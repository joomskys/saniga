<?php 
// Heading
$widget->add_render_attribute( 'heading', 'class', 'cms-heading cms-mainheading text-40 lh-55 col-lg-10 mb-15');
...
// Sub Heading
$widget->add_render_attribute( 'subheading', 'class', 'cms-subheading text-16 lh-27 font-700 text-283b6a pt-35 mb-15');
...
// Description
$widget->add_render_attribute( 'description', 'class', 'cms-heading-desc text-16 lh-27 pt-10');
...
<div class="cms-heading-wrapper <?php echo saniga_elementor_align_class($settings);?>">
    ...
    <?php if ( !empty($settings['heading_text']) ) { ?>
        <div class="row"><div <?php etc_print_html($widget->get_render_attribute_string( 'heading' )); ?>><?php 
