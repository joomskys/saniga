<?php 
// Wrap 
$widget->add_render_attribute( 'wrap', 'class', 'cms-page-title-wrapper p-tb-50 pt-tb-lg-100 p-tb-xl-150');
...
$widget->add_render_attribute( 'heading', 'class', 'cms-heading text-30 lh-40 text-lg-50 lh-lg-60 text-xl-75 lh-xl-85 font-700 mt-n15');
...
$widget->add_render_attribute( 'description', 'class', 'cms-heading-desc text-17 lh-27 font-700 pt-15');
        ...
        <div class="row">
            <div class="<?php echo esc_attr($col.' '.$col_lg.' '.$col_xl);?>">
                <div class="cms-page-title-content">
                    ...
                    ?></div>
                    <div class="row gutters-30 gutters-grid pt-30 empty-none"><?php
