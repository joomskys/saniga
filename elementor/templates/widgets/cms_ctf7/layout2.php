...
?>
    <div id="<?php echo esc_attr($html_id); ?>" class="cms-cf7 relative">
        <div class="cms-cf7-inner">
            <div class="cms-form-heading cms-heading text-24 font-700 mt-n8 pb-8"><?php echo esc_html($widget->get_setting('form_title','Get In Touch')); ?></div>
            <div class="cms-form-desc text-15 lh-25 pt-10"><?php echo esc_html($widget->get_setting('form_desc', 'We take great pride in everything that we do, control over products allows us to ensure our customers receive the best quality service.')); ?></div>
            <div class="pt-25"><?php 
