...
$title = $widget->get_setting('title', 'The best disinfectants and procedures to keep individuals safe.');
...
$background_img = saniga_elementor_image_url_render($settings, [
    ...
    'default_img' => get_template_directory_uri().'/elementor/templates/widgets/cms_fancy_box/layout-images/bg-2.png'
]);
...
if($settings['bg_color'] !== 'custom'){
    $widget->add_render_attribute( 'content-wrap', 'class', 'bg-'.$widget->get_setting('bg_color', 'accent'));
}
